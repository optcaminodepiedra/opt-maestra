...
const ROUTE_PERMISSIONS: Record<string, string[]> = {
  ...
  // Restaurante (Iris MANAGER_RANCH también tiene restaurante: Los Jabalíes + Cantina Lobo)
  "/app/restaurant": ["MASTER_ADMIN","OWNER","SUPERIOR","MANAGER_OPS","MANAGER_RESTAURANT","MANAGER_RANCH","STAFF_WAITER","STAFF_BAR","STAFF_CASHIER","STAFF_KITCHEN","MANAGER"],
