  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto space-y-6">
      <ManagerSectionHeader
        ...
        sectionBaseHref="/app/manager/ranch/reports"
      />

      <div className="flex items-center justify-center gap-3">
        <Button variant="outline" size="sm" asChild>
          <Link href={`/app/manager/ranch/reports?y=${prev.y}&m=${prev.m}${bizQuery}`}>
        ...
        <Button variant="outline" size="sm" asChild>
          <Link href={`/app/manager/ranch/reports?y=${next.y}&m=${next.m}${bizQuery}`}>
